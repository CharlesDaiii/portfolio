...
import { g as useTheme, u as useInViewport, b as useWindowSize, e as media } from "./server-build-CQcGY3tM.js";
import { useReducedMotion, useSpring } from "framer-motion";
import { useRef, useMemo, useEffect, startTransition } from "react";
...
import { c as cleanScene, a as cleanRenderer, r as removeLights } from "./three-Bpxpz58r.js";
...
const canvas = "_canvas_h61ls_1";
const overlay = "_overlay_h61ls_12";
const styles = {
  canvas,
  overlay
};
...
const DisplacementSphere = (props) => {
  ...
  useEffect(() => {
    const onMouseMove = throttle((event) => {
      ...
      rotationX.set(position2.y / 2);
      rotationY.set(position2.x / 2);
    }, 100);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: styles.overlay, "aria-hidden": true })
  ] });
};
export {
  DisplacementSphere
